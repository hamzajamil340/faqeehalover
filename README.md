...
<head>
    ...
    <title>Happy Birthday Faqeeha Javed 🎂</title>
...
<body>
    ...
    <header>
        ...
        <p class="subtitle">🎂 Happy Birthday Meri Jaan! 🎂</p>
    ...
    <section class="countdown-section">
        <div class="countdown-card">
            <h2 class="countdown-title">Tumhare Special Day Mein ⏰</h2>
    ...
    <section class="messages-section">
        <div class="message-card">
            ...
            <p class="message-text">
                ...
                Tumhare saath har pal khaas hai aur har din ek nayi khushi lata hai. ✨
            </p>
        </div>
        ...
        <div class="message-card">
            ...
            <p class="message-text">
                ...
                Tumhare bina ye duniya adhoori lagti hai. Allah tumhe hamesha khush rakhe! 🤲
            </p>
        </div>
        ...
        <div class="message-card">
            ...
            <p class="message-text">
                ...
                Kyunki tum mere liye duniya ki sabse pyari ho. Happy Birthday in advance meri jaan! 🎉
            </p>
        </div>
    ...
    <section class="gallery-section">
        <h2 class="gallery-title">Kya Hai Khaas Tumhare Baare Mein 💝</h2>
    ...
    <section class="wishes-section">
        <div class="wish-card">
            <h2 class="wish-main">Happy Birthday Faqeeha Javed! 🎂</h2>
            <p class="wish-sub">
    ...
    <footer>
        ...
        <p class="footer-text">Made with endless love for Faqeeha Javed 💝</p>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (distance < 0) {
                document.querySelector('.countdown-title').textContent = '🎉 Happy Birthday Faqeeha! 🎉';
                document.getElementById('countdown').innerHTML = '<div style="font-size: 3rem; text-align: center; grid-column: 1/-1;">🎂🎊🎁🎈</div>';
            }
        }
